...
import 'package:my_template/features/home/presentation/view/screen/generate_lesson_ideas_screen.dart';
...
class AILessonAssistantScreen extends StatelessWidget {
  const AILessonAssistantScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(
        ...
        centerTitle: true,
        title: Text(
          AppLocalKay.teacher_assistant.tr(),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildActionCard(
              context,
              title: AppLocalKay.generate_lesson_ideas_title.tr(),
              subtitle: AppLocalKay.generate_lesson_ideas_subtitle.tr(),
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => BlocProvider(
                      ...
                      child: const GenerateLessonIdeasScreen(),
                    ),
                  ),
                );
              },
            ...
            _buildActionCard(
              context,
              title: AppLocalKay.generate_quiz_title.tr(),
              subtitle: AppLocalKay.generate_quiz_subtitle.tr(),
            ...
            _buildActionCard(
              context,
              title: AppLocalKay.summarize_notes_title.tr(),
              subtitle: AppLocalKay.summarize_notes_subtitle.tr(),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Gap(8.h),
                Text(
                  AppLocalKay.ai_welcome_subtitle.tr(),
      ...
      child: Column(
        children: [
          Container(
            ...
            child: Text(
              AppLocalKay.coming_soon_student_analysis.tr(),
              style: AppTextStyle.bodySmall(
                context,
              ).copyWith(color: AppColor.grey600Color(context)),
            ),
